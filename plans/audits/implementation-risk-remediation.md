...
- 2026-04-25: Completed a Stage 8 monitoring-tier increment by documenting explicit foreground/background monitor support-tier semantics, updating client probe/widget regressions to avoid synthetic lifecycle operators, and documenting server placement behavior for monitor support tiers.
