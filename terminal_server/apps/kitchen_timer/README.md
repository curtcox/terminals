...
`terminal_server/internal/scenario`. The app runtime can load this package and
validate its manifest, but it does not yet interpret the TAL lifecycle hooks.
