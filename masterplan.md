...
- [plans/protocol.md](plans/features/protocol/plan.md) — gRPC control plane, WebRTC media plane, data channels. Protocol changes follow [docs/protocol-evolution.md](docs/protocol-evolution.md).
