...
4. Add protobuf-level integration tests covering register-first enforcement, per-session device-id consistency, register/capability/heartbeat/disconnect lifecycle, initial `SetUI`, command start/stop dedupe, system query results, and recoverable error continuation.
